...
public class CreateAccountFragment extends Fragment {
    ...
    private EditText edtEmailID, edtPasswordSignUp, edtUsername;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        txtLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((RegistrationActivity)getActivity()).setFragment(new LoginFragment());
            }
        });
...
//                            updateUI(user);
                            ((RegistrationActivity)getActivity()).setFragment(new ProfileFragment(edtUsername.getText().toString()));
...
//        }else {
//
//            Toast.makeText(getContext(), "Please Register or Log IN", Toast.LENGTH_SHORT).show();
//        }
//
//    }
